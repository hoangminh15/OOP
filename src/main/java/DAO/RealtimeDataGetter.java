...
public class RealtimeDataGetter extends DataGetter implements iResultSetter {
    ...
    public DataRealtime layDataTheoMa(String namThangNgay, String maSanNotConvertedYet, String maCoPhieu){
        ...
        System.out.println("Day la gia mo cua " + giaMoCua);
    ...
    public void fetchDataRealtimeAndPutInDatabase(String maSan) {
        ...
        try {
            ...
            for (Element row : rows) {
                ...
                klgdKhopLenh = Long.parseLong(Arrays.stream(price[5].split(",")).collect(joining()));
                gtgdKhopLenh = Long.parseLong(Arrays.stream(price[5].split(",")).collect(joining()));
